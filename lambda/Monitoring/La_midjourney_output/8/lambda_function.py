        ...
        if "s_t" not in message_body['object_key']:
            ...
            if message_body['state']=='before':
                ...
                try:
                    ...
                    # s3 upload
                    s3 = boto3.client('s3')
                    s3.upload_file("/tmp/image1.jpg","s3-kkobook-character", f"upscale/{user_id}/{time_stamp}/1.jpg")
                    s3.upload_file("/tmp/image2.jpg","s3-kkobook-character", f"upscale/{user_id}/{time_stamp}/2.jpg")
                    s3.upload_file("/tmp/image3.jpg","s3-kkobook-character", f"upscale/{user_id}/{time_stamp}/3.jpg")
                    s3.upload_file("/tmp/image4.jpg","s3-kkobook-character", f"upscale/{user_id}/{time_stamp}/4.jpg")
                except:
                    print("why?")
